...
use tetsy_wasm::elements::{External, FunctionType, Internal, Type, ValueType};
...
fn main() {
    ...
    // This test shows how to implement native module https://github.com/NikVolf/tetsy-wasm/blob/master/src/interpreter/tests/basics.rs#L197
